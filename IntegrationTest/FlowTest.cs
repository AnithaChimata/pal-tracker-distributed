...
namespace IntegrationTest
{
    public class FlowTest : IDisposable
    {
        ...
        private readonly AppServerBuilder.AppServer _registrationServer;
        private readonly AppServerBuilder.AppServer _allocationsServer;
        private readonly AppServerBuilder.AppServer _backlogServer;
        private readonly AppServerBuilder.AppServer _timesheetsServer;
